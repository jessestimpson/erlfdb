...
static void *erlfdb_network_thread(void *arg) {
...
static ERL_NIF_TERM erlfdb_create_future(ErlNifEnv *env, ERL_NIF_TERM *tx_ref,
    ...
    err = fdb_future_set_callback(f->future, erlfdb_future_cb, (void *)f);
...
static inline ERL_NIF_TERM erlfdb_future_get_void(ErlNifEnv *env,
                                                  ErlFDBFuture *f) {
    fdb_error_t err;
...
static inline ERL_NIF_TERM erlfdb_future_get_int64(ErlNifEnv *env,
                                                   ErlFDBFuture *f) {
    int64_t fdb_res;
...
static inline ERL_NIF_TERM erlfdb_future_get_key(ErlNifEnv *env,
                                                 ErlFDBFuture *f) {
    const uint8_t *key;
    int len;
    unsigned char *buf;
...
static inline ERL_NIF_TERM erlfdb_future_get_value(ErlNifEnv *env,
                                                   ErlFDBFuture *f) {
    fdb_bool_t present;
    const uint8_t *val;
    int len;
...
static inline ERL_NIF_TERM erlfdb_future_get_string_array(ErlNifEnv *env,
                                                          ErlFDBFuture *f) {
    const char **strings;
    int count;
    unsigned char *buf;
...
static inline ERL_NIF_TERM erlfdb_future_get_key_array(ErlNifEnv *env,
                                                       ErlFDBFuture *f) {
    FDBKey const *keys;
    int count;
    unsigned char *buf;
    ...
    for (i = count - 1; i >= 0; i--) {
        buf = enif_make_new_binary(env, keys[i].key_length, &bin);
        memcpy(buf, keys[i].key, keys[i].key_length);
        ret = enif_make_list_cell(env, bin, ret);
    }
...
static inline ERL_NIF_TERM erlfdb_future_get_keyvalue_array(ErlNifEnv *env,
                                                            ErlFDBFuture *f) {
...
static ERL_NIF_TERM erlfdb_get_max_api_version(ErlNifEnv *env, int argc,
                                               const ERL_NIF_TERM argv[]) {
...
static ERL_NIF_TERM erlfdb_select_api_version(ErlNifEnv *env, int argc,
                                              const ERL_NIF_TERM argv[]) {
    ErlFDBSt *st = (ErlFDBSt *)enif_priv_data(env);
    int vsn;
    fdb_error_t err;
...
static ERL_NIF_TERM erlfdb_network_set_option(ErlNifEnv *env, int argc,
                                              const ERL_NIF_TERM argv[]) {
    ErlFDBSt *st = (ErlFDBSt *)enif_priv_data(env);
...
static ERL_NIF_TERM erlfdb_setup_network(ErlNifEnv *env, int argc,
                                         const ERL_NIF_TERM argv[]) {
    ErlFDBSt *st = (ErlFDBSt *)enif_priv_data(env);
    fdb_error_t err;
...
static ERL_NIF_TERM erlfdb_future_cancel(ErlNifEnv *env, int argc,
                                         const ERL_NIF_TERM argv[]) {
    ErlFDBSt *st = (ErlFDBSt *)enif_priv_data(env);
    ErlFDBFuture *future;
    void *res;
...
static ERL_NIF_TERM erlfdb_future_silence(ErlNifEnv *env, int argc,
                                          const ERL_NIF_TERM argv[]) {
    ErlFDBSt *st = (ErlFDBSt *)enif_priv_data(env);
    ErlFDBFuture *future;
    void *res;
...
static ERL_NIF_TERM erlfdb_future_is_ready(ErlNifEnv *env, int argc,
                                           const ERL_NIF_TERM argv[]) {
    ErlFDBSt *st = (ErlFDBSt *)enif_priv_data(env);
    ErlFDBFuture *future;
    void *res;
...
static ERL_NIF_TERM erlfdb_future_get_error(ErlNifEnv *env, int argc,
                                            const ERL_NIF_TERM argv[]) {
    ErlFDBSt *st = (ErlFDBSt *)enif_priv_data(env);
    ErlFDBFuture *future;
    fdb_error_t err;
...
static ERL_NIF_TERM erlfdb_future_get(ErlNifEnv *env, int argc,
                                      const ERL_NIF_TERM argv[]) {
    ErlFDBSt *st = (ErlFDBSt *)enif_priv_data(env);
    ErlFDBFuture *f;
    void *res;
...
static ERL_NIF_TERM erlfdb_create_database(ErlNifEnv *env, int argc,
                                           const ERL_NIF_TERM argv[]) {
    ErlFDBSt *st = (ErlFDBSt *)enif_priv_data(env);
    ErlNifBinary bin;
...
static ERL_NIF_TERM erlfdb_database_open_tenant(ErlNifEnv *env, int argc,
                                                const ERL_NIF_TERM argv[]) {
    ErlFDBSt *st = (ErlFDBSt *)enif_priv_data(env);
    ErlNifBinary bin;
    ErlFDBDatabase *d;
    ...
    err = fdb_database_open_tenant(d->database, (const unsigned char *)bin.data,
                                   bin.size - 1, &tenant);
    if (err != 0) {
        return erlfdb_erlang_error(env, err);
    }
...
static ERL_NIF_TERM erlfdb_database_set_option(ErlNifEnv *env, int argc,
                                               const ERL_NIF_TERM argv[]) {
    ErlFDBSt *st = (ErlFDBSt *)enif_priv_data(env);
    ErlFDBDatabase *d;
    ...
    err = fdb_database_set_option(d->database, option, (uint8_t *)value.data,
                                  value.size);
...
static ERL_NIF_TERM
erlfdb_database_create_transaction(ErlNifEnv *env, int argc,
                                   const ERL_NIF_TERM argv[]) {
    ErlFDBSt *st = (ErlFDBSt *)enif_priv_data(env);
    ErlFDBDatabase *d;
    ErlFDBTransaction *t;
...
static ERL_NIF_TERM erlfdb_transaction_set_option(ErlNifEnv *env, int argc,
                                                  const ERL_NIF_TERM argv[]) {
    ErlFDBSt *st = (ErlFDBSt *)enif_priv_data(env);
    ErlFDBTransaction *t;
    ...
    err = fdb_transaction_set_option(t->transaction, option,
...
static ERL_NIF_TERM
erlfdb_transaction_set_read_version(ErlNifEnv *env, int argc,
                                    const ERL_NIF_TERM argv[]) {
    ErlFDBSt *st = (ErlFDBSt *)enif_priv_data(env);
    ErlFDBTransaction *t;
...
static ERL_NIF_TERM
erlfdb_transaction_get_read_version(ErlNifEnv *env, int argc,
                                    const ERL_NIF_TERM argv[]) {
    ErlFDBSt *st = (ErlFDBSt *)enif_priv_data(env);
    ERL_NIF_TERM tx_ref;
    ErlFDBTransaction *t;
    ...
    if (!enif_get_resource(env, tx_ref, ErlFDBTransactionRes, &res)) {
        return enif_make_badarg(env);
    }
    t = (ErlFDBTransaction *)res;
    ...
    return erlfdb_create_future(env, &tx_ref, NULL, future, ErlFDB_FT_INT64);
}

static ERL_NIF_TERM erlfdb_transaction_get(ErlNifEnv *env, int argc,
                                           const ERL_NIF_TERM argv[]) {
    ErlFDBSt *st = (ErlFDBSt *)enif_priv_data(env);
    ERL_NIF_TERM tx_ref;
    ErlFDBTransaction *t;
    ...
    future = fdb_transaction_get(t->transaction, (uint8_t *)key.data, key.size,
                                 snapshot);

    return erlfdb_create_future(env, &tx_ref, NULL, future, ErlFDB_FT_VALUE);
}

#if FDB_API_VERSION >= 630
static ERL_NIF_TERM
erlfdb_transaction_get_estimated_range_size(ErlNifEnv *env, int argc,
                                            const ERL_NIF_TERM argv[]) {
    ErlFDBSt *st = (ErlFDBSt *)enif_priv_data(env);
    ERL_NIF_TERM tx_ref;
    ErlFDBTransaction *t;
    ...
    future = fdb_transaction_get_estimated_range_size_bytes(
        t->transaction, (uint8_t *)skey.data, skey.size, (uint8_t *)ekey.data,
        ekey.size);
...
static ERL_NIF_TERM erlfdb_transaction_get_key(ErlNifEnv *env, int argc,
                                               const ERL_NIF_TERM argv[]) {
    ErlFDBSt *st = (ErlFDBSt *)enif_priv_data(env);
    ERL_NIF_TERM tx_ref;
    ErlFDBTransaction *t;
    ...
    future = fdb_transaction_get_key(t->transaction, (uint8_t *)key.data,
                                     key.size, or_equal, offset, snapshot);

    return erlfdb_create_future(env, &tx_ref, NULL, future, ErlFDB_FT_KEY);
}

static ERL_NIF_TERM
erlfdb_transaction_get_addresses_for_key(ErlNifEnv *env, int argc,
                                         const ERL_NIF_TERM argv[]) {
    ErlFDBSt *st = (ErlFDBSt *)enif_priv_data(env);
    ERL_NIF_TERM tx_ref;
    ErlFDBTransaction *t;
    ...
    future = fdb_transaction_get_addresses_for_key(
        t->transaction, (uint8_t *)key.data, key.size);

    return erlfdb_create_future(env, &tx_ref, NULL, future,
                                ErlFDB_FT_STRING_ARRAY);
}

static ERL_NIF_TERM erlfdb_transaction_get_range(ErlNifEnv *env, int argc,
                                                 const ERL_NIF_TERM argv[]) {
    ErlFDBSt *st = (ErlFDBSt *)enif_priv_data(env);
    ERL_NIF_TERM tx_ref;
    ErlFDBTransaction *t;
    ...
    future = fdb_transaction_get_range(
        ...
        (uint8_t *)ekey.data, ekey.size, eor_equal, eoffset, limit,
...
static ERL_NIF_TERM
erlfdb_transaction_get_range_split_points(ErlNifEnv *env, int argc,
                                          const ERL_NIF_TERM argv[]) {
    ErlFDBSt *st = (ErlFDBSt *)enif_priv_data(env);
    ERL_NIF_TERM tx_ref;
    ErlFDBTransaction *t;
    ...
    if (!enif_get_int(env, argv[3], &chunk_size)) {
        return enif_make_badarg(env);
    }

    future = fdb_transaction_get_range_split_points(
        t->transaction, (uint8_t *)skey.data, skey.size, (uint8_t *)ekey.data,
        ekey.size, chunk_size);
...
static ERL_NIF_TERM erlfdb_transaction_set(ErlNifEnv *env, int argc,
    ...
    fdb_transaction_set(t->transaction, (uint8_t *)key.data, key.size,
...
static ERL_NIF_TERM erlfdb_transaction_clear(ErlNifEnv *env, int argc,
                                             const ERL_NIF_TERM argv[]) {
    ErlFDBSt *st = (ErlFDBSt *)enif_priv_data(env);
    ErlFDBTransaction *t;
    ErlNifBinary key;
...
static ERL_NIF_TERM erlfdb_transaction_clear_range(ErlNifEnv *env, int argc,
                                                   const ERL_NIF_TERM argv[]) {
    ErlFDBSt *st = (ErlFDBSt *)enif_priv_data(env);
    ErlFDBTransaction *t;
    ErlNifBinary skey;
    ...
    fdb_transaction_clear_range(t->transaction, (uint8_t *)skey.data, skey.size,
                                (uint8_t *)ekey.data, ekey.size);
...
static ERL_NIF_TERM erlfdb_transaction_atomic_op(ErlNifEnv *env, int argc,
                                                 const ERL_NIF_TERM argv[]) {
    ErlFDBSt *st = (ErlFDBSt *)enif_priv_data(env);
    ErlFDBTransaction *t;
    ErlNifBinary key;
    ...
    fdb_transaction_atomic_op(t->transaction, (uint8_t *)key.data, key.size,
                              (uint8_t *)param.data, param.size, mtype);
...
static ERL_NIF_TERM erlfdb_transaction_commit(ErlNifEnv *env, int argc,
                                              const ERL_NIF_TERM argv[]) {
    ErlFDBSt *st = (ErlFDBSt *)enif_priv_data(env);
    ERL_NIF_TERM tx_ref;
    ErlFDBTransaction *t;
    ...
    return erlfdb_create_future(env, &tx_ref, NULL, future, ErlFDB_FT_VOID);
}

static ERL_NIF_TERM
erlfdb_transaction_get_committed_version(ErlNifEnv *env, int argc,
                                         const ERL_NIF_TERM argv[]) {
    ErlFDBSt *st = (ErlFDBSt *)enif_priv_data(env);
    ErlFDBTransaction *t;
    int64_t fdb_vsn;
...
static ERL_NIF_TERM
erlfdb_transaction_get_versionstamp(ErlNifEnv *env, int argc,
                                    const ERL_NIF_TERM argv[]) {
    ErlFDBSt *st = (ErlFDBSt *)enif_priv_data(env);
    ERL_NIF_TERM tx_ref;
    ErlFDBTransaction *t;
    ...
    if (!enif_get_local_pid(env, argv[1], &to)) {
        return enif_make_badarg(env);
    }
    ...
    return erlfdb_create_future(env, NULL, &to, future, ErlFDB_FT_KEY);
}
...
static ERL_NIF_TERM erlfdb_transaction_watch(ErlNifEnv *env, int argc,
    ...
    if (!enif_get_local_pid(env, argv[2], &to)) {
        return enif_make_badarg(env);
    }

    future =
        fdb_transaction_watch(t->transaction, (uint8_t *)key.data, key.size);

    t->has_watches = true;

    // A watch's future is not tied to the transaction. This allows
    // {reference(), ready} messages to be delivered to a caller's message
    // queue, and must be handled. For example, if called by a gen_server,
    // {reference(), ready} will appear in the handle_info.
    return erlfdb_create_future(env, NULL, &to, future, ErlFDB_FT_VOID);
}

static ERL_NIF_TERM erlfdb_transaction_on_error(ErlNifEnv *env, int argc,
                                                const ERL_NIF_TERM argv[]) {
    ErlFDBSt *st = (ErlFDBSt *)enif_priv_data(env);
    ERL_NIF_TERM tx_ref;
    ErlFDBTransaction *t;
...
static ERL_NIF_TERM erlfdb_transaction_reset(ErlNifEnv *env, int argc,
                                             const ERL_NIF_TERM argv[]) {
    ErlFDBSt *st = (ErlFDBSt *)enif_priv_data(env);
    ErlFDBTransaction *t;
    void *res;
...
static ERL_NIF_TERM erlfdb_transaction_cancel(ErlNifEnv *env, int argc,
                                              const ERL_NIF_TERM argv[]) {
    ErlFDBSt *st = (ErlFDBSt *)enif_priv_data(env);
    ErlFDBTransaction *t;
    void *res;
...
static ERL_NIF_TERM
erlfdb_transaction_add_conflict_range(ErlNifEnv *env, int argc,
                                      const ERL_NIF_TERM argv[]) {
    ErlFDBSt *st = (ErlFDBSt *)enif_priv_data(env);
    ErlFDBTransaction *t;
    ErlNifBinary skey;
...
static ERL_NIF_TERM
erlfdb_transaction_get_approximate_size(ErlNifEnv *env, int argc,
                                        const ERL_NIF_TERM argv[]) {
    ErlFDBSt *st = (ErlFDBSt *)enif_priv_data(env);
    ERL_NIF_TERM tx_ref;
    ErlFDBTransaction *t;
...
static ERL_NIF_TERM
erlfdb_transaction_get_next_tx_id(ErlNifEnv *env, int argc,
                                  const ERL_NIF_TERM argv[]) {
    ErlFDBSt *st = (ErlFDBSt *)enif_priv_data(env);
    ErlFDBTransaction *t;
    void *res;
...
static ERL_NIF_TERM erlfdb_transaction_is_read_only(ErlNifEnv *env, int argc,
                                                    const ERL_NIF_TERM argv[]) {
    ErlFDBSt *st = (ErlFDBSt *)enif_priv_data(env);
    ErlFDBTransaction *t;
    void *res;
...
static ERL_NIF_TERM erlfdb_transaction_has_watches(ErlNifEnv *env, int argc,
                                                   const ERL_NIF_TERM argv[]) {
    ErlFDBSt *st = (ErlFDBSt *)enif_priv_data(env);
    ErlFDBTransaction *t;
    void *res;
...
static ERL_NIF_TERM
erlfdb_transaction_get_writes_allowed(ErlNifEnv *env, int argc,
                                      const ERL_NIF_TERM argv[]) {
    ErlFDBSt *st = (ErlFDBSt *)enif_priv_data(env);
    ErlFDBTransaction *t;
    void *res;
...
static ERL_NIF_TERM erlfdb_get_error(ErlNifEnv *env, int argc,
                                     const ERL_NIF_TERM argv[]) {
    int erl_err;
    fdb_error_t fdb_err;
    const char *str_err;
...
static ERL_NIF_TERM erlfdb_error_predicate(ErlNifEnv *env, int argc,
                                           const ERL_NIF_TERM argv[]) {
    int erl_err;
    fdb_error_t fdb_err;
...
static ErlNifFunc funcs[] = {
    ...
    NIF_FUNC(erlfdb_transaction_get_versionstamp, 2),
    NIF_FUNC(erlfdb_transaction_watch, 3),
